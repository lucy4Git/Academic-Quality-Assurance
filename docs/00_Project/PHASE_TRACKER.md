...
| **Integration Sprint** | **Wave 1 Live Data Wiring** | **✅** | **2026-07-07** | **2026-07-07** | **Split 2 Wave 1** | **Engineering** | **1125 tests (+13), 4 new tenant-isolated endpoints (live-counts, provenance-summary, coverage-summary, full-profile), RAG/crawler readiness scoring, dashboard KPIs replaced with live counts, knowledge foundation + institution profile pages wired to live data, AI /ask safe error wrapper (503, no stack-trace leak), verification script, TSC clean** |
| **Split 2 Wave 2** | **Public Knowledge Acquisition Engine** | **✅** | **2026-07-07** | **2026-07-07** | **Split 2 Wave 1** | **Engineering** | **1147 tests (+22), acquisition package (checksum/robots/detector/classifier/downloader/deduplicator/job_manager), 5 new models + migration c3d4e5f6a7b8, /acquisition router (sources/jobs/logs/downloads/statistics/retry, tenant-isolated), 28-source public registry (26 SA universities + 2 demo), /knowledge/acquisition workspace, robots.txt respected, 5-download local safety cap, TSC clean, build passing** |
